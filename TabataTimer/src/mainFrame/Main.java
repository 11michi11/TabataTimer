...
/**
 * TabataTimer is exercise assistant program for tabata training. It displays
 * countdown for exercise and rest part, number of rounds and number of done
 * tabata. It also plays music for each round. Training can be adjusted in
 * settings menu.
 * 
 * @author Micha³ Pompa
 * @version Alpha 3.0
...
public class Main extends JFrame {
	...
	JPanel exercisesList = new JPanel();
	exercisesList.setBackground(new Color(0, 0, 0, 0));
	...
	aboutItem.addActionListener(new ActionListener() {
		...
		JOptionPane.showMessageDialog(Main.this, "This is bacis timer for Tabata.\n"
			...
			+ "Contact: 11michi11@gmail.com", "About", JOptionPane.PLAIN_MESSAGE);
	    }
	});
